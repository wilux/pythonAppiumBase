...
caps = {}
caps["appium:deviceName"] = "Pixel 6 API 33"
caps["appium:udid"] = "emulator-5554"
caps["platformName"] = "Android"
caps["appium:appPackage"] = "com.poincenot.bpn.mobile.qa"
caps["appium:appActivity"] = "com.poincenot.doit.controller.activity.SplashActivity"
...
el4.click()
accept_button = driver.find_element(by=AppiumBy.XPATH, value="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[4]")
accept_button.click()